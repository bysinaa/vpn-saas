...
- The script installs prerequisites, clones/updates the repo to /opt/vpn-saas, installs deps, builds the CLI and runs the interactive install flow.

Safety tips (read before running)
1. Inspect the script first:
   curl -Ls https://raw.githubusercontent.com/bysinaa/vpn-saas/main/scripts/install.sh | sed -n '1,200p'
   or open https://raw.githubusercontent.com/bysinaa/vpn-saas/main/scripts/install.sh in your browser or editor.
