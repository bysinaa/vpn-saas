...
uninstall_everything() {
  ...
  if docker compose -p tazaxy -f "$INSTALL_DIR/docker-compose.yml" ps >/dev/null 2>&1; then
    docker compose -p tazaxy -f "$INSTALL_DIR/docker-compose.yml" down --remove-orphans
