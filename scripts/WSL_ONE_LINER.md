...
- Example: run installer from branch "main" into /opt/vpn-saas
...
1) In WSL:
   curl -Ls https://raw.githubusercontent.com/bysinaa/vpn-saas/main/scripts/install.sh -o ~/vpn-install.sh
