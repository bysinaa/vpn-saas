...
export const config = {
  ...
  xui: {
    baseUrl: env.XUI_PANEL_BASE_URL,
    apiKey: env.XUI_PANEL_API_KEY,
    username: env.XUI_PANEL_USERNAME,
    password: env.XUI_PANEL_PASSWORD,
    timeoutMs: env.XUI_PANEL_TIMEOUT_MS,
    maxRetries: env.XUI_PANEL_MAX_RETRIES,
    syncCron: env.XUI_PANEL_SYNC_CRON,
    subPort: env.XUI_PANEL_SUB_PORT,
    subPath: env.XUI_PANEL_SUB_PATH,
    sessionTtlMs: env.XUI_PANEL_SESSION_TTL_MS,
    defaultInboundId: env.XUI_PANEL_DEFAULT_INBOUND_ID,
  },
  payments: {
    online: {
      enabled: env.ONLINE_GATEWAY_ENABLED,
      sandbox: env.ONLINE_GATEWAY_SANDBOX,
