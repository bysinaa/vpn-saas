...
import { PaymentsController, WalletOrderPaymentsController } from './payments.controller';
...
@Module({
  imports: [WalletModule, OrdersModule, SubscriptionsModule, VpnModule, NotificationsModule, SettingsModule],
  controllers: [PaymentsController, WalletOrderPaymentsController, BankCardsAdminController],
  providers: [
