...
export type BotState =
  ...
  // admin CRUD wizards (spec #9/#10 — manage plans, settings, payment methods in-bot)
  | 'admin_plan_awaiting_field'
  | 'admin_voucher_awaiting_uses'
...
export type PaymentMethodChoice = 'WALLET' | 'ONLINE' | 'CARD_TO_CARD' | 'CRYPTO';
